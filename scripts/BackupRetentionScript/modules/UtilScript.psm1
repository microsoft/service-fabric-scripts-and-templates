    ...
    try {
        ...
        if($err.Error.Code -eq "FABRIC_E_PARTITION_NOT_FOUND")
        {
            ...
            if($DeleteNotFoundPartitions -eq $true)
            {
                ...
                Write-Warning "If you want to remove data on this partition as well, please run the script by enabling DeleteNotFoundPartitions flag."
...
{   
    ...
    Write-Host "The total number of partitions found on the cluster $ClusterEndpoint are $length"
