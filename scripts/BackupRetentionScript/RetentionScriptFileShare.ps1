...
Function Get-LogonUserToken 
{
    ...
    [Parameter(Mandatory=$true)][SecureString]$PassToUse,
    ...
    $unmanagedString = [System.Runtime.InteropServices.Marshal]::SecureStringToBSTR($PassToUse)
...
if($UserName)
{
    ...
    $userToken = Get-LogonUserToken  -Username $userNameToTry -Domain $domain -PassToUse $Global:Pass
